...
extern _ATL_FUNC_INFO OnCurrentStatusInfo8kCam4,OnImageCapturedInfo8kCam4,OnCaptureAvailableInfo8kCam4;


class Sink8kCam4 : public IDispEventSimpleImpl<1,Sink8kCam4,&DIID__ICameraCtrlEvents>
{
public:

	BEGIN_SINK_MAP(Sink8kCam4)
	SINK_ENTRY_INFO(1, DIID__ICameraCtrlEvents, 1, OnCurrentStatus8kCam4, &OnCurrentStatusInfo8kCam4)
	SINK_ENTRY_INFO(1, DIID__ICameraCtrlEvents, 2, OnImageCaptured8kCam4, &OnImageCapturedInfo8kCam4)
	SINK_ENTRY_INFO(1, DIID__ICameraCtrlEvents, 3, OnCaptureAvailable8kCam4, &OnCaptureAvailableInfo8kCam4)
	END_SINK_MAP()
	...
	bool checkDataReady();
	Sink8kCam4(ICameraCtrl* pcamera,unsigned short * data);
	Sink8kCam4();
	~Sink8kCam4(void);
	int getImageSizeX();
	int getImageSizeY();
...
private:
	ICameraCtrl* m_pCameraCam4;
	unsigned short * m_pCapturedDataShortCam4;
	...
	unsigned short*  accumulatorBIAS_camera4;
	unsigned short*  accumulatorFLAT_camera4;
