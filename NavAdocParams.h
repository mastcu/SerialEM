...
BOOL_SETT_ASSIGN("DosymTrackBigReversal", tsParam->dosymTrackBigReversal)
INT_SETT_ASSIGN("DosymBigTiltToTrack", tsParam->dosymBigTiltToTrack)
...
INT_SETT_ASSIGN("TSFlags", tsParam->tsFlags)
...
FLOAT_SETT_ASSIGN("BlockShiftLimit", montParam->maxBlockImShiftNonLM)
FLOAT_SETT_ASSIGN("BlockLMShiftLimit", montParam->maxBlockImShiftLM)
