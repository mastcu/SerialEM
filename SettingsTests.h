...
INT_SETT_GETSET("CircleTypesInLDDefine", mWinApp->, CircleTypesInLDDefine)
BOOL_SETT_GETSET("ReverseWheelZoom", mWinApp->, ReverseWheelZoom)
...
FLOAT_SETT_GETSET("DynFocusTiltOffset", camera->, DynFocusTiltOffset)
...
INT_SETT_GETSET("SaveInEERformat", camera->, SaveInEERorLZW)
BOOL_SETT_GETSET("DectrisSaveAsHDF", camera->, DectrisSaveAsHDF)
...
BOOL_SETT_GETSET("Autocontrast", mBufferManager->, Autocontrast)
...
BOOL_SETT_ASSIGN("MontageEvalPeaks", montParam->evalMultiplePeaks)
INT_SETT_GETSET("MontageMinimumCounts", mWinApp->mMontageController->, CountLimit)
FLOAT_SETT_GETSET("MontGridMapCutoffInvUm", mWinApp->mMontageController->, GridMapCutoffInvUm)
FLOAT_SETT_GETSET("MontGridMapMinSizeMm", mWinApp->mMontageController->, GridMapMinSizeMm)
...
BOOL_SETT_ASSIGN("MontageImShiftInBlocks", montParam->imShiftInBlocks)
FLOAT_SETT_ASSIGN("MontBlockShiftLimit", montParam->maxBlockImShiftNonLM)
FLOAT_SETT_ASSIGN("MontBlockLMShiftLimit", montParam->maxBlockImShiftLM)
...
BOOL_SETT_ASSIGN("MontageCloseFile", montParam->closeFileWhenDone)
#endif
...
BOOL_SETT_GETSET("SaveLogAsRTF", mWinApp->, SaveLogAsRTF)
INT_SETT_GETSET("AutoPruneLogLines2", mWinApp->, AutoPruneLogLines)
...
FLOAT_SETT_GETSET("LMBeamTilt", mWinApp->mFocusManager->, LMBeamTilt)
...
INT_SETT_GETSET("IdleTimeToStopEmission", mWinApp->mScope->, IdleTimeToStopEmission)
INT_SETT_GETSET("LastImageBeamTilt", mWinApp->mScope->, LastImageBeamTilt)
...
FLOAT_SETT_GETSET("LastRecFocus", mWinApp->mScope->, LastRecordAbsFocus)
...
INT_SETT_GETSET("NumCamMacRows", mWinApp->mMacroProcessor->, NumCamMacRows)
INT_SETT_GETSET("NumStatusLines", mWinApp->mMacroProcessor->, NumStatusLines)
...
BOOL_SETT_GETSET("EnableMultiChanView", mWinApp->, EnableMultiChanView)
...
BOOL_SETT_GETSET("ClickUseCtfplotter", mWinApp->mProcessImage->, ClickUseCtfplotter)
BOOL_SETT_GETSET("TuneUseCtfplotter", mWinApp->mProcessImage->, TuneUseCtfplotter)
INT_SETT_GETSET("CtfExpectedPhase", mWinApp->mProcessImage->, CtfExpectedPhase)
...
BOOL_SETT_GETSET("ReopenDialogsFromExit", mWinApp->, ReopenDlgsFromExit)
...
BOOL_SETT_GETSET("SkipLDBlankInAcquire", mWinApp->mNavHelper->, SkipLDBlankInAcquire)
...
BOOL_SETT_GETSET("ShowStateNumbers", mWinApp->mNavHelper->, ShowStateNumbers)
BOOL_SETT_GETSET("ShowTableIndexes", mWinApp->mNavHelper->, ShowTableIndexes)
...
FLOAT_SETT_ASSIGN("LDAutoShiftMaxPctChg", mWinApp->mLowDoseDlg.mAutoShiftMaxPctChg)
FLOAT_SETT_ASSIGN("LDAutoShiftMaxRot", mWinApp->mLowDoseDlg.mAutoShiftMaxRot)
FLOAT_SETT_ASSIGN("LDAutoViewMaxShift", mWinApp->mLowDoseDlg.mAutoViewMaxShift)
FLOAT_SETT_ASSIGN("LDAutoSearchMaxShift", mWinApp->mLowDoseDlg.mAutoSearchMaxShift)
...
INT_SETT_GETSET("AutoCenUseMagInd", mWinApp->mMultiTSTasks->, AutoCenUseMagInd)
FLOAT_SETT_GETSET("AutoCenFOVLimit", mWinApp->mMultiTSTasks->, AutoCenFOVLimit)
...
INT_SETT_GETSET("NumCtfFrames", mWinApp->mAutoTuning->, NumCtfFrames)
INT_SETT_GETSET("AlignParamSetNum", mWinApp->mAutoTuning->, AlignParamSetNum)
BOOL_SETT_GETSET("CtfUseFocusInLD", mWinApp->mAutoTuning->, CtfUseFocusInLD)
...
BOOL_SETT_ASSIGN("RefineZLPWithTrial", mFilterParam->refineWithTrial)
...
FLOAT_SETT_GETSET("MainChansSplitFrac", mWinApp->, MainChansSplitFrac)
#endif
