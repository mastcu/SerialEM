...
FLOAT_SETT_ASSIGN("TiltSeriesCosinePower", mTSParam->cosinePower)
...
BOOL_SETT_ASSIGN("TSWaitForDrift", mTSParam->waitForDrift)
INT_SETT_ASSIGN("TSOnlyWaitAboveBelow", mTSParam->onlyWaitDriftAboveBelow)
FLOAT_SETT_ASSIGN("TSWaitAboveAngle", mTSParam->waitDriftAboveAngle)
FLOAT_SETT_ASSIGN("TSWaitBelowAngle", mTSParam->waitDriftBelowAngle)
BOOL_SETT_ASSIGN("TSWaitAtReversals", mTSParam->waitAtDosymReversals)
BOOL_SETT_ASSIGN("TSWaitDosymIgnore", mTSParam->waitDosymIgnoreAngles)
