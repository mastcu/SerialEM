static const int sNumSignatures = 793;
...
"W for LD axis position bug/autoloader/preventing DE retraction on exit/more output from TestNextMultiShot\r\n"
...
"y for reports when background saving starts and ends, add * for adoc mutex output\r\n"
