...
#define IobjFlagExtraInSlicer 22
#define IobjFlagPlanar    23
...
#define IOBJ_EXFLAG_SLICER_ONLY  (1 << 1)
#define IOBJ_EXFLAG_MESH_ON_IMG  (1 << 2)
...
extern "C" {
  ...
  int   imodObjectSetName(Iobj *inObject, const char *inName);
