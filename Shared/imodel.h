...
#define IMODF_HAS_MESH_THICK  (1l << 9)  /* Mesh thickness is now possible */
...
#define MAX_AUTO_SLICE_THREADS 8
...
extern "C" {
  ...
  (float ksigma, double highthresh, double lowthresh, int exact, int dim, int minsize,
   ...
   int *ylist, unsigned char **linePtrs, float mean, int ksec, int listsize, 
   int numThreads);
