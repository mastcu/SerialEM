...
INT_PROP_TEST("MakeFEIerrorBeTimeout", camera->, MakeFEIerrorBeTimeout)
...
INT_PROP_TEST("UseAPI2ForDE", camera->, UseAPI2ForDE)
INT_PROP_TEST("ScreenInIfDetectorOut", camera->, ScreenInIfDetectorOut)
INT_PROP_TEST("CEOSServerPort", camera->, CEOSserverPort)
INT_PROP_TEST("EDMServerPort", camera->, EDMserverPort)
INT_PROP_TEST("EDMFrequency", camera->, EDMfrequency)
...
BOOL_PROP_TEST("SaveK3CountingGainAsTIFF", camera->, SaveK3GainAsTIFF)
BOOL_PROP_TEST("SkipFocusRamper", camera->, SkipFocusRamper)
...
INT_PROP_TEST("RamperBlankAtEnd", camera->, RamperBlankAtEnd)
INT_PROP_TEST("MinimumShotInterval", camera->, MinShotInterval)
BOOL_PROP_TEST("SaveNewImageToShrMem", camera->, SaveNewImageToShrMem)
...
BOOL_PROP_TEST("NoLDAreaMoveWithLine", mWinApp->, NoLDAreaMoveWithLine)
...
FLOAT_PROP_TEST("FlybackWarningFocusTol", camera->, FlybackWarningFocusTol)
...
FLOAT_PROP_TEST("ExtraSTEMTimeout", camera->, ExtraSTEMTimeout)
FLOAT_PROP_TEST("FirstSTEMExtraTimeout", camera->, FirstSTEMExtraTimeout)
...
INT_PROP_TEST("MonitorC2ApertureSize", scope->, MonitorC2ApertureSize)
INT_PROP_TEST("ShowApertureStatus", scope->, ShowApertureStatus)
INT_PROP_TEST("UseAperturesInStates", scope->, UseAperturesInStates)
INT_PROP_TEST("SkipNormalizations", scope->, SkipNormalizations)
INT_PROP_TEST("UseImageBeamTilt", scope->, UseImageBeamTilt)
...
FLOAT_PROP_TEST("STEMFocusStep", focusManager->, SFmidFocusStep)
...
INT_PROP_TEST("MinMagIndexForAutofocus", focusManager->, MinMagIndForFocus)
...
INT_PROP_TEST("PostProbeBeamDelay", scope->, PostProbeBeamDelay)
INT_PROP_TEST("PostOpenValvesDelay", scope->, OpenValvesDelay)
...
INT_PROP_TEST("JeolCondenserApertureID", scope->, JeolCondenserApIDtoUse)
...
FLOAT_PROP_TEST("JeolLMStemCL3ToMicrons", scope->, JeolStemLMCL3toUm)
BOOL_PROP_TEST("UseCL3ToSetLMStemFocus", scope->, UseCL3LmStemFocus)
...
INT_PROP_TEST("JeolGaugeSwitchDelay", scope->, GaugeSwitchDelay)
BOOL_PROP_TEST("SkipJeolNeutralCheck", scope->, SkipJeolNeutralCheck)
INT_PROP_TEST("FEIcanGetLoaderNames", scope->, FEIcanGetLoaderNames)
...
BOOL_PROP_TEST("UseDetectorNameIfUtapi", scope->, UseDetectorNameIfUtapi)
INT_PROP_TEST("UtapiDisconnectThreshold", scope->, UtapiDisconnectThres)
...
FLOAT_PROP_TEST("MultiInHoleOnAxisMinTilt", mWinApp->mParticleTasks->, MSinHoleOnAxisMinTilt)
BOOL_PROP_TEST("DropPlusInHoleNameIfUtapi", mWinApp->mParticleTasks->, MSDropPlusFromName)
FLOAT_PROP_TEST("MultiShotMinTiltForFocus", mWinApp->mParticleTasks->, MSminTiltToCompensate)
...
BOOL_PROP_TEST("MulGridRefineStageMont", mWinApp->mMultiGridTasks->, RefineUseStageMont)
...
FLOAT_PROP_TEST("GIFslitWidthScaling", camera->, GIFslitWidthScaling)
...
FLOAT_PROP_TEST("EERScalingForAlignInIMOD", EERscaleForIMODalign)
FLOAT_PROP_TEST("LinearToCountingRatio", linear2CountingRatio)
FLOAT_PROP_TEST("UtapiLinearToCounting", UtapiLinear2Counting)
