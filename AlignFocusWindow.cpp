...
PANEL_END,
IDC_BUTALIGN, IDC_BUTFOCUS, IDC_BUT_TO_MARKER, IDC_BUTCLEARALIGN, IDC_BUT_EUCEN_FOCUS,
...
IDC_APPLYISOFFSET, IDC_CORRECT_BACKLASH, IDC_SET_TRIM_FRAC, IDC_ERASE_PERIODIC_PEAKS,
PANEL_END, TABLE_END};
