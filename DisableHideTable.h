...
static DisableHideItem sDisableHideList[] =
{
  ...
  {"Buffer Status state", 4, 0, 0},
  {"Buffer Control state", 4, 0, 1},
  {"Image Display state", 4, 0, 2},
  {"Scope Status state", 4, 0, 3},
  {"Scope Control state", 4, 0, 4},
  {"Tilt panel state", 4, 0, 5},
  {"Camera&Script state", 4, 0, 6},
  {"Image Align state", 4, 0, 7},
  {"Low Dose state", 4, 0, 8},
  {"Montage panel state", 4, 0, 9},
  {"STEM Control state", 4, 0, 10},
  {"Filter Control state", 4, 0, 11},
  {"DE Camera state", 4, 0, 12},
