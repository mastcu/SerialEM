...
// 7/5/13: Modified for 64-bit build of SerialEM: DoModel returns an INT_PTR and
// OnTimer takes a UINT_PTR
// 7/10/13: Commented out WINNT and FILENAMESIZE outputs for cleaner compile
...
//=============================================================================
{
	...
	m_bPersist             = FALSE;
	m_bVistaFlag           = FALSE;
	// THIS FAILED IN VS2005 SO MAKE IT FOR AFTER THAT
#if _MFC_VER > 0x800
