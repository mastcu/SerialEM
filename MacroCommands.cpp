...
static CmdItem cmdList[] = {{"ScriptEnd", 0, 0, &CMacCmd::ScriptEnd},
  {"Label", 0, 0, &CMacCmd::NoOperation}, {"SetVariable", 0, 0, &CMacCmd::SetVariableCmd},
  {"SetStringVar", 0, 0, &CMacCmd::SetStringVar}, {"DoKeyBreak", 0, 0, &CMacCmd::Break},
  {"ZeroLoopElseIf", 0, 0, &CMacCmd::If}, {"NotFound", 0, 0},
  {NULL, 0, 0, &CMacCmd::View}, {NULL, 0, 0, &CMacCmd::Focus},
  {NULL, 0, 0, &CMacCmd::Trial}, {NULL, 0, 0, &CMacCmd::Record},
  {NULL, 0, 0, &CMacCmd::Preview}, {"A", 0, 0, &CMacCmd::AutoAlign},
  {"AlignTo", 1, 0, &CMacCmd::AutoAlign}, {"AutoAlign", 0, 0, &CMacCmd::AutoAlign},
  ...
  {"CircleFromPoints", 6, 1, &CMacCmd::CircleFromPoints},
  {"ClearAlignment", 0, 0, &CMacCmd::ClearAlignment},
  {"CloseFile", 0, 4, &CMacCmd::CloseFile}, {"ConicalAlignTo", 1, 0, &CMacCmd::AutoAlign},
  {"Continue", 0, 4, &CMacCmd::Break}, {"Copy", 2, 0, &CMacCmd::Copy},
  {"D", 0, 0, &CMacCmd::TiltDown}, {"Delay", 1, 1, &CMacCmd::Delay},
  {"DoMacro", 1, 4, &CMacCmd::DoMacro}, {"Echo", 0, 4, &CMacCmd::Echo},
  {"Else", 0, 4, &CMacCmd::Else}, {"Endif", 0, 4, &CMacCmd::Endif},
  {"EndLoop", 0, 4, &CMacCmd::EndLoop}, {"Eucentricity", 0, 0, &CMacCmd::Eucentricity},
  {"ExposeFilm", 0, 1, &CMacCmd::ExposeFilm}, {"F", 0, 0, &CMacCmd::Focus},
  {"G", 0, 0, &CMacCmd::AutoFocus}, {"GoToLowDoseArea", 1, 0, &CMacCmd::GoToLowDoseArea},
  {"If", 3, 4, &CMacCmd::If},
  {"ImageShiftByMicrons", 2, 1, &CMacCmd::ImageShiftByMicrons},
  {"ImageShiftByPixels", 2, 1, &CMacCmd::ImageShiftByPixels},
  {"ImageShiftByUnits", 2, 1, &CMacCmd::ImageShiftByUnits},
  {"IncPercentC2", 1, 1, &CMacCmd::SetPercentC2}, {"L", 0, 0, &CMacCmd::Preview},
  {"Loop", 1, 5, &CMacCmd::Loop}, {"M", 0, 0, &CMacCmd::Montage},
  {"MacroName", 1, 4, &CMacCmd::NoOperation}, {"LongName", 1, 4, &CMacCmd::NoOperation},
  {"ManualFilmExposure", 1, 1, &CMacCmd::ManualFilmExposure},
  {"Montage", 0, 0, &CMacCmd::Montage}, {"MoveStage", 2, 1, &CMacCmd::MoveStage},
  {"MoveStageTo", 2, 1, &CMacCmd::MoveStage}, {"NewMap", 0, 0, &CMacCmd::NewMap},
  {"OpenNewFile", 1, 4, &CMacCmd::OpenNewFile},
  {"OpenNewMontage", 1, 4, &CMacCmd::OpenNewFile}, {"Pause", 0, 4, &CMacCmd::Pause},
  {"QuadrantMeans", 0, 4, &CMacCmd::QuadrantMeans}, {"R", 0, 0, &CMacCmd::Record},
  {"ReadFile", 0, 0, &CMacCmd::ReadFile},
  {"RealignToNavItem", 1, 0, &CMacCmd::RealignToNavItem},
  {"RealignToOtherItem", 2, 0, &CMacCmd::RealignToNavItem},
  {"RecordAndTiltDown", 0, 0, &CMacCmd::RecordAndTiltUp},
  {"RecordAndTiltUp", 0, 0, &CMacCmd::RecordAndTiltUp},
  {"RefineZLP", 0, 0, &CMacCmd::RefineZLP}, {"Repeat", 0, 4, &CMacCmd::Repeat},
  {"ReportAccumShift", 0, 0, &CMacCmd::ReportAccumShift},
  {"ReportAlignShift", 0, 0, &CMacCmd::ReportAlignShift},
  {"ReportBeamShift", 0, 0, &CMacCmd::ReportBeamShift},
  {"ReportClock", 0, 0, &CMacCmd::ReportClock},
  {"ReportDefocus", 0, 0, &CMacCmd::ReportDefocus},
  ...
  {"ReportStageXYZ", 0, 0, &CMacCmd::ReportStageXYZ},
  {"ReportTiltAngle", 0, 0, &CMacCmd::ReportTiltAngle},
  {"ResetAccumShift", 0, 0, &CMacCmd::ResetAccumShift},
  {"ResetClock", 0, 4, &CMacCmd::ResetClock},
  {"ResetImageShift", 0, 0, &CMacCmd::ResetImageShift},
  {"ResetShiftIfAbove", 1, 1, &CMacCmd::ResetShiftIfAbove},
  {"RestoreCameraSet", 0, 4, &CMacCmd::RestoreCameraSetCmd},
  {"RetractCamera", 0, 0, &CMacCmd::RetractCamera},
  {"ReverseTilt", 0, 0, &CMacCmd::ReverseTilt}, {"S", 0, 0, &CMacCmd::Save},
  {"Save", 0, 0, &CMacCmd::Save}, {"ScreenDown", 0, 0, &CMacCmd::ScreenDown},
  {"ScreenUp", 0, 0, &CMacCmd::ScreenUp}, {"SetBeamBlank", 1, 0, &CMacCmd::SetBeamBlank},
  {"SetBeamShift", 2, 0, &CMacCmd::SetBeamShift},
  {"SetBinning", 2, 4, &CMacCmd::SetBinning},
  {"SetCamLenIndex", 1, 0, &CMacCmd::SetCamLenIndex},
  ...
  {"SetMag", 1, 0, &CMacCmd::SetMag}, {"SetObjFocus", 1, 0, &CMacCmd::SetObjFocus},
  {"SetPercentC2", 1, 0, &CMacCmd::SetPercentC2},
  {"SetSlitIn", 0, 1, &CMacCmd::SetSlitIn},
  {"SetSlitWidth", 1, 0, &CMacCmd::SetSlitWidth},
  {"SetSpotSize", 1, 0, &CMacCmd::SetSpotSize}, {"Show", 1, 0, &CMacCmd::Show},
  {"SubareaMean", 4, 5, &CMacCmd::SubareaMean},
  {"SuppressReports", 0, 4, &CMacCmd::SuppressReports},
  {"SwitchToFile", 1, 4, &CMacCmd::SwitchToFile}, {"T", 0, 0, &CMacCmd::Trial},
  {"TiltBy", 1, 1, &CMacCmd::TiltTo}, {"TiltDown", 0, 0, &CMacCmd::TiltDown},
  {"TiltTo", 1, 1, &CMacCmd::TiltTo}, {"TiltUp", 0, 0, &CMacCmd::TiltUp},
  {"U", 0, 0, &CMacCmd::TiltUp}, {"V", 0, 0, &CMacCmd::View},
  {"WaitForDose", 1, 1, &CMacCmd::WaitForDose}, {"WalkUpTo", 1, 1, &CMacCmd::WalkUpTo},
  {"Return", 0, 4, &CMacCmd::ScriptEnd}, {"Exit", 0, 4, &CMacCmd::ScriptEnd},
  {"MoveToNavItem", 0, 0, &CMacCmd::MoveToNavItem},
  {"SkipPiecesOutsideItem", 1, 4, &CMacCmd::SkipPiecesOutsideItem},
  {"IncTargetDefocus", 1, 5, &CMacCmd::IncTargetDefocus},
  {"ReportFileZsize", 0, 0, &CMacCmd::ReportFileZsize},
  {"SpecialExposeFilm", 2, 1, &CMacCmd::ExposeFilm},
  {"SetMontageParams", 1, 4, &CMacCmd::SetMontageParams},
  {"AutoCenterBeam", 0, 0, &CMacCmd::AutoCenterBeam},
  {"CookSpecimen", 0, 0, &CMacCmd::CookSpecimen},
  {"ImageProperties", 0, 4, &CMacCmd::ImageProperties},
  {"ItemForSuperCoord", 1, 4, &CMacCmd::ItemForSuperCoord},
  {"SetNewFileType", 1, 4, &CMacCmd::SetNewFileType},
  {"ShiftItemsByAlignment", 0, 4, &CMacCmd::ShiftItemsByAlignment},
  {"ShiftImageForDrift", 3, 0, &CMacCmd::ShiftImageForDrift},
  {"ReportFocusDrift", 0, 0, &CMacCmd::ReportFocusDrift},
  {"CalibrateImageShift", 0, 0, &CMacCmd::CalibrateImageShift},
  {"SetMagAndIntensity", 1, 0, &CMacCmd::ChangeMagAndIntensity},
  ...
  {"CropImage", 5, 1, &CMacCmd::CropImage},
  {"ClearPersistentVars", 0, 4, &CMacCmd::ClearPersistentVars},
  {"ElseIf", 3, 4, &CMacCmd::Else}, {"YesNoBox", 1, 4, &CMacCmd::Pause},
  {"MakeDirectory", 1, 4, &CMacCmd::SetDirectory},
  {"AllowFileOverwrite", 1, 4, &CMacCmd::AllowFileOverwrite},
  {"OppositeTrial", 0, 0, &CMacCmd::OppositeTrial},
  {"OppositeFocus", 0, 0, &CMacCmd::OppositeTrial},
  {"OppositeAutoFocus", 0, 0, &CMacCmd::OppositeTrial},
  {"ReportAutoFocus", 0, 0, &CMacCmd::ReportAutoFocus},
  {"ReportTargetDefocus", 0, 0, &CMacCmd::ReportTargetDefocus},
  {"Plugin", 2, 0, &CMacCmd::Plugin},
  {"ListPluginCalls", 0, 4, &CMacCmd::ListPluginCalls},
  {"SetStandardFocus", 1, 4, &CMacCmd::SetStandardFocus},
  {"SetCameraArea", 2, 4, &CMacCmd::SetCameraArea},
  {"SetIlluminatedArea", 1, 0, &CMacCmd::SetIlluminatedArea},
  {"ReportIlluminatedArea", 0, 0, &CMacCmd::ReportIlluminatedArea},
  {"SelectCamera", 1, 0, &CMacCmd::SelectCamera},
  {"SetLowDoseMode", 1, 0, &CMacCmd::SetLowDoseMode},
  {"TestSTEMshift", 3, 1, &CMacCmd::TestSTEMshift},
  {"QuickFlyback", 2, 1, &CMacCmd::QuickFlyback},
  {"NormalizeLenses", 1, 0, &CMacCmd::NormalizeLenses},
  {"ReportSlotStatus", 1, 4, &CMacCmd::ReportSlotStatus},
  {"LoadCartridge", 1, 0, &CMacCmd::LoadCartridge},
  {"UnloadCartridge", 0, 0, &CMacCmd::LoadCartridge},
  {"BacklashAdjust", 0, 0, &CMacCmd::BacklashAdjust},
  {"SaveFocus", 0, 4, &CMacCmd::SaveFocus},
  {"MakeDateTimeDir", 0, 4, &CMacCmd::MakeDateTimeDir},
  {"EnterNameOpenFile", 0, 4, &CMacCmd::EnterNameOpenFile},
  {"FindPixelSize", 0, 0, &CMacCmd::FindPixelSize},
  {"SetEucentricFocus", 0, 4, &CMacCmd::SetEucentricFocus},
  {"CameraProperties", 0, 4, &CMacCmd::CameraProperties},
  {"SetImageShift", 2, 0, &CMacCmd::SetImageShift},
  {"ReportImageShift", 0, 0, &CMacCmd::ReportImageShift},
  {"EnterOneNumber", 1, 4, &CMacCmd::EnterOneNumber},
  {"SetHelperParams", 1, 4, &CMacCmd::SetHelperParams},
  {"StepFocusNextShot", 2, 5, &CMacCmd::StepFocusNextShot},
  {"BeamTiltDirection", 1, 5, &CMacCmd::BeamTiltDirection},
  {"OpenFrameSumFile", 1, 4, &CMacCmd::OpenNewFile},
  {"DeferStackingNextShot", 0, 4, &CMacCmd::DeferStackingNextShot},
  {"SetObjectiveStigmator", 2, 0, &CMacCmd::SetObjectiveStigmator},
  {"ReportObjectiveStigmator", 0, 0, &CMacCmd::ReportObjectiveStigmator},
  {"AreDewarsFilling", 0, 4, &CMacCmd::AreDewarsFilling},
  {"DewarsRemainingTime", 0, 4, &CMacCmd::DewarsRemainingTime},
  {"RefrigerantLevel", 0, 4, &CMacCmd::RefrigerantLevel},
  {"OpenDECameraCover", 0, 0, &CMacCmd::OpenDECameraCover},
  {"SmoothFocusNextShot", 2, 5, &CMacCmd::SmoothFocusNextShot},
  {"ReportLowDose", 0, 4, &CMacCmd::ReportLowDose},
  {"IsPVPRunning", 0, 4, &CMacCmd::IsPVPRunning},
  {"LongOperation", 1, 1, &CMacCmd::LongOperation},
  {"UpdateHWDarkRef", 1, 1, &CMacCmd::UpdateHWDarkRef},
  {"RestoreFocus", 0, 4, &CMacCmd::RestoreFocus},
  {"CalEucentricFocus", 0, 4, &CMacCmd::CalEucentricFocus},
  {"EarlyReturnNextShot", 1, 5, &CMacCmd::EarlyReturnNextShot},
  {"SelectPiezo", 2, 0, &CMacCmd::RestoreBeamTilt},
  {"ReportPiezoXY", 0, 0, &CMacCmd::ReportPiezoXY},
  {"ReportPiezoZ", 0, 0, &CMacCmd::ReportPiezoZ},
  {"MovePiezoXY", 2, 1, &CMacCmd::MovePiezoXY},
  {"MovePiezoZ", 1, 1, &CMacCmd::MovePiezoZ}, {"KeyBreak", 0, 4, &CMacCmd::NoOperation},
  {"ReportAlpha", 0, 0, &CMacCmd::ReportAlpha}, {"SetAlpha", 1, 0, &CMacCmd::SetAlpha},
  {"SetSTEMDetectors", 2, 0, &CMacCmd::SetSTEMDetectors},
  {"SetCenteredSize", 4, 4, &CMacCmd::SetCenteredSize},
  {"ImageLowDoseSet", 0, 4, &CMacCmd::ImageLowDoseSet},
  {"ForceCenterRealign", 0, 4, &CMacCmd::ForceCenterRealign},
  {"SetTargetDefocus", 1, 4, &CMacCmd::SetTargetDefocus},
  {"FocusChangeLimits", 2, 5, &CMacCmd::FocusChangeLimits},
  {"AbsoluteFocusLimits", 2, 5, &CMacCmd::AbsoluteFocusLimits},
  {"ReportColumnMode", 0, 0, &CMacCmd::ReportColumnMode},
  {"ReportLens", 1, 0, &CMacCmd::ReportLens}, {"ReportCoil", 1, 0, &CMacCmd::ReportCoil},
  {"ReportAbsoluteFocus", 0, 0, &CMacCmd::ReportFocus},
  {"SetAbsoluteFocus", 1, 0, &CMacCmd::SetStandardFocus},
  {"ReportEnergyFilter", 0, 0, &CMacCmd::ReportEnergyFilter},
  {"ReportBeamTilt", 0, 0, &CMacCmd::ReportBeamTilt},
  {"UserSetDirectory", 0, 4, &CMacCmd::UserSetDirectory},
  {"SetJeolSTEMflags", 2, 2, &CMacCmd::SetJeolSTEMflags},
  {"ProgramTimeStamps", 0, 4, &CMacCmd::ProgramTimeStamps},
  {"SetContinuous", 2, 2, &CMacCmd::SetContinuous},
  {"UseContinuousFrames", 1, 4, &CMacCmd::UseContinuousFrames},
  {"WaitForNextFrame", 0, 0, &CMacCmd::WaitForNextFrame},
  {"StopContinuous", 0, 0, &CMacCmd::StopContinuous},
  {"ReportContinuous", 0, 4, &CMacCmd::ReportContinuous},
  {"SetLiveSettleFraction", 1, 4, &CMacCmd::SetLiveSettleFraction},
  {"SkipTo", 1, 4, &CMacCmd::SkipTo}, {"Function", 1, 4, &CMacCmd::ScriptEnd},
  {"EndFunction", 0, 4, &CMacCmd::ScriptEnd}, {"CallFunction", 1, 4, &CMacCmd::DoMacro},
  {"PreCookMontage", 1, 1, &CMacCmd::Montage},
  {"ReportAlignTrimming", 0, 0, &CMacCmd::ReportAlignTrimming},
  {"NormalizeAllLenses", 0, 0, &CMacCmd::NormalizeAllLenses},
  {"AddToAutodoc", 6, 5, &CMacCmd::AddToAutodoc},
  {"IsVariableDefined", 1, 4, &CMacCmd::IsVariableDefined},
  {"EnterDefaultedNumber", 3, 4, &CMacCmd::EnterOneNumber},
  {"SetupWaffleMontage", 2, 6, &CMacCmd::SetupWaffleMontage},
  {"IncMagIfFoundPixel", 1, 0, &CMacCmd::ChangeMag},
  {"ResetDefocus", 0, 0, &CMacCmd::ResetDefocus},
  {"WriteAutodoc", 0, 4, &CMacCmd::AddToAutodoc},
  {"ElectronStats", 0, 4, &CMacCmd::ElectronStats},
  {"ErrorsToLog", 0, 4, &CMacCmd::ErrorsToLog},
  {"FlashDisplay", 0, 0, &CMacCmd::FlashDisplay},
  {"ReportProbeMode", 0, 0, &CMacCmd::ReportProbeMode},
  {"SetProbeMode", 1, 0, &CMacCmd::SetProbeMode},
  {"SaveLogOpenNew", 0, 4, &CMacCmd::SaveLogOpenNew},
  {"SetAxisPosition", 2, 0, &CMacCmd::SetAxisPosition}
  , {"AddToFrameMdoc", 2, 4, &CMacCmd::AddToFrameMdoc},
  {"WriteFrameMdoc", 0, 4, &CMacCmd::AddToFrameMdoc},
  {"ReportFrameMdocOpen", 0, 4, &CMacCmd::ReportFrameMdocOpen},
  {"ShiftCalSkipLensNorm", 0, 4, &CMacCmd::ShiftCalSkipLensNorm},
  {"ReportLastAxisOffset", 0, 0, &CMacCmd::ReportLastAxisOffset},
  {"SetBeamTilt", 2, 0, &CMacCmd::SetBeamTilt},//end in 3.5
  {"CorrectAstigmatism", 0, 0, &CMacCmd::CorrectAstigmatism},
  {"CorrectComa", 0, 0, &CMacCmd::CorrectComa},
  {"ShiftItemsByCurrentDiff", 1, 4, &CMacCmd::ShiftItemsByCurrentDiff},
  {"ReportCurrentFilename", 0, 4, &CMacCmd::ReportCurrentFilename},
  {"SuffixForExtraFile", 1, 4, &CMacCmd::SuffixForExtraFile},
  {"ReportScreen", 0, 0, &CMacCmd::ReportScreen},
  {"GetDeferredSum", 0, 0, &CMacCmd::GetDeferredSum},
  {"ReportJeolGIF", 0, 0, &CMacCmd::ReportJeolGIF},
  ...
  {"ReadOtherFile", 3, 4, &CMacCmd::ReadOtherFile},
  {"ReportK2FileParams", 0, 0, &CMacCmd::ReportK2FileParams},
  {"SetK2FileParams", 1, 4, &CMacCmd::SetK2FileParams},
  {"SetDoseFracParams", 1, 4, &CMacCmd::SetDoseFracParams},
  {"SetK2ReadMode", 2, 4, &CMacCmd::SetK2ReadMode},
  {"SetProcessing", 2, 4, &CMacCmd::SetProcessing},
  {"SetFrameTime", 2, 4, &CMacCmd::SetFrameTime},
  {"ReportCountScaling", 0, 0, &CMacCmd::ReportCountScaling},
  {"SetDivideBy2", 1, 4, &CMacCmd::SetDivideBy2},
  {"ReportNumFramesSaved", 0, 0, &CMacCmd::ReportNumFramesSaved},
  {"RemoveFile", 1, 4, &CMacCmd::RemoveFile},
  {"ReportFrameAliParams", 0, 0, &CMacCmd::ReportFrameAliParams},
  {"SetFrameAliParams", 1, 4, &CMacCmd::ReportFrameAliParams},
  {"Require", 1, 4, &CMacCmd::NoOperation},
  {"OnStopCallFunc", 1, 4, &CMacCmd::OnStopCallFunc},
  {"RetryReadOtherFile", 1, 4, &CMacCmd::RetryReadOtherFile},
  {"DoScript", 1, 4, &CMacCmd::DoMacro}, {"CallScript", 1, 4, &CMacCmd::DoMacro},
  {"ScriptName", 1, 4, &CMacCmd::NoOperation},
  {"SetFrameAli2", 1, 4, &CMacCmd::ReportFrameAliParams},
  {"ReportFrameAli2", 0, 0, &CMacCmd::ReportFrameAliParams},
  {"ReportMinuteTime", 0, 0, &CMacCmd::ReportMinuteTime},
  {"ReportColumnOrGunValve", 0, 0, &CMacCmd::ReportColumnOrGunValve},
  {"NavIndexWithLabel", 1, 4, &CMacCmd::NavIndexWithLabel},
  {"NavIndexWithNote", 1, 4, &CMacCmd::NavIndexWithLabel},
  {"SetDiffractionFocus", 1, 0, &CMacCmd::SetDiffractionFocus},
  {"ReportDirectory", 0, 0, &CMacCmd::ReportDirectory},
  {"BackgroundTilt", 1, 1, &CMacCmd::BackgroundTilt},
  {"ReportStageBusy", 0, 0, &CMacCmd::ReportStageBusy},
  {"SetExposureForMean", 1, 0, &CMacCmd::SetExposureForMean},
  {"FFT", 1, 0, &CMacCmd::FFT},
  {"ReportNumNavAcquire", 0, 0, &CMacCmd::ReportNumNavAcquire},
  {"StartFrameWaitTimer", 0, 4, &CMacCmd::StartFrameWaitTimer},
  {"ReportTickTime", 0, 0, &CMacCmd::ReportTickTime},
  {"ReadTextFile", 2, 4, &CMacCmd::ReadTextFile},
  {"RunInShell", 1, 0, &CMacCmd::RunInShell},
  {"ElapsedTickTime", 1, 5, &CMacCmd::ElapsedTickTime},
  {"NoMessageBoxOnError", 0, 4, &CMacCmd::NoMessageBoxOnError},
  {"ReportAutofocusOffset", 0, 0, &CMacCmd::ReportAutofocusOffset},
  {"SetAutofocusOffset", 1, 4, &CMacCmd::SetAutofocusOffset},
  {"ChooserForNewFile", 2, 4, &CMacCmd::ChooserForNewFile},
  {"SkipAcquiringNavItem", 0, 4, &CMacCmd::SkipAcquiringNavItem},
  {"ShowMessageOnScope", 1, 0, &CMacCmd::ShowMessageOnScope},
  {"SetupScopeMessage", 1, 6, &CMacCmd::SetupScopeMessage},
  {"Search", 0, 0, &CMacCmd::Search},
  {"SetProperty", 2, 4, &CMacCmd::SetProperty}, /* End in 3.6 */
  {"SetMagIndex", 1, 0, &CMacCmd::SetMagIndex},
  {"SetNavRegistration", 1, 4, &CMacCmd::SetNavRegistration},
  {"LocalVar", 1, 4, &CMacCmd::LocalVar},
  {"LocalLoopIndexes", 0, 4, &CMacCmd::LocalLoopIndexes},
  {"ZemlinTableau", 1, 1, &CMacCmd::ZemlinTableau},
  {"WaitForMidnight", 0, 1, &CMacCmd::WaitForMidnight},
  {"ReportUserSetting", 1, 0, &CMacCmd::ReportUserSetting},
  {"SetUserSetting", 2, 4, &CMacCmd::SetUserSetting},
  {"ChangeItemRegistration", 2, 5, &CMacCmd::ChangeItemRegistration},
  {"ShiftItemsByMicrons", 2, 5, &CMacCmd::ShiftItemsByMicrons},
  {"SetFreeLensControl", 2, 1, &CMacCmd::SetFreeLensControl},
  {"SetLensWithFLC", 2, 0, &CMacCmd::SetLensWithFLC},
  {"SaveToOtherFile", 4, 4, &CMacCmd::SaveToOtherFile},
  {"SkipAcquiringGroup", 0, 4, &CMacCmd::SkipAcquiringGroup},
  {"ReportImageDistanceOffset", 0, 0, &CMacCmd::ReportImageDistanceOffset},
  {"SetImageDistanceOffset", 1, 0, &CMacCmd::SetImageDistanceOffset},
  {"ReportCameraLength", 0, 0, &CMacCmd::ReportCameraLength},
  {"SetDECamFrameRate", 1, 4, &CMacCmd::SetDECamFrameRate},
  {"SkipMoveInNavAcquire", 0, 4, &CMacCmd::SkipMoveInNavAcquire},
  {"TestRelaxingStage", 2, 1, &CMacCmd::MoveStage},
  {"RelaxStage", 0, 1, &CMacCmd::RelaxStage},
  {"SkipFrameAliParamCheck", 0, 4, &CMacCmd::SkipFrameAliParamCheck},
  {"IsVersionAtLeast", 1, 4, &CMacCmd::IsVersionAtLeast},
  {"SkipIfVersionLessThan", 1, 4, &CMacCmd::IsVersionAtLeast},
  {"RawElectronStats", 0, 4, &CMacCmd::ElectronStats},
  {"AlignWholeTSOnly", 0, 4, &CMacCmd::AlignWholeTSOnly},
  {"WriteComForTSAlign", 0, 4, &CMacCmd::WriteComForTSAlign},
  {"RecordAndTiltTo", 1, 1, &CMacCmd::RecordAndTiltUp},
  {"ArePostActionsEnabled", 0, 4, &CMacCmd::ArePostActionsEnabled},
  {"MeasureBeamSize", 0, 4, &CMacCmd::MeasureBeamSize},
  {"MultipleRecords", 0, 1, &CMacCmd::MultipleRecords},
  {"MoveBeamByMicrons", 2, 1, &CMacCmd::MoveBeamByMicrons},
  {"MoveBeamByFieldFraction", 2, 1, &CMacCmd::MoveBeamByFieldFraction},
  {"NewDEserverDarkRef", 2, 0, &CMacCmd::NewDEserverDarkRef},
  {"StartNavAcquireAtEnd", 0, 0, &CMacCmd::StartNavAcquireAtEnd},
  {"ReduceImage", 2, 1, &CMacCmd::ReduceImage},
  {"ReportAxisPosition", 1, 0, &CMacCmd::SetAxisPosition},
  {"CtfFind", 3, 1, &CMacCmd::CtfFind}, {"CBAstigComa", 3, 0, &CMacCmd::CBAstigComa},
  {"FixAstigmatismByCTF", 0, 0, &CMacCmd::FixAstigmatismByCTF},
  {"FixComaByCTF", 0, 0, &CMacCmd::FixAstigmatismByCTF},
  {"EchoEval", 0, 5, &CMacCmd::EchoEval},
  {"ReportFileNumber", 0, 0, &CMacCmd::ReportFileNumber},
  {"ReportComaTiltNeeded", 0, 0, &CMacCmd::ReportComaTiltNeeded},
  {"ReportStigmatorNeeded", 0, 0, &CMacCmd::ReportStigmatorNeeded},
  {"SaveBeamTilt", 0, 4, &CMacCmd::SaveBeamTilt},
  ...
  {"StripEndingDigits", 2, 4, &CMacCmd::StripEndingDigits},
  {"MakeAnchorMap", 0, 0, &CMacCmd::MakeAnchorMap},
  {"StageShiftByPixels", 2, 1, &CMacCmd::MoveStage},
  {"ReportProperty", 1, 0, &CMacCmd::ReportUserSetting},
  {"SaveNavigator", 0, 4, &CMacCmd::SaveNavigator},
  {"FrameThresholdNextShot", 1, 5, &CMacCmd::FrameThresholdNextShot},
  {"QueueFrameTiltSeries", 3, 4, &CMacCmd::QueueFrameTiltSeries},
  {"FrameSeriesFromVar", 2, 4, &CMacCmd::QueueFrameTiltSeries},
  {"WriteFrameSeriesAngles", 1, 4, &CMacCmd::WriteFrameSeriesAngles},
  {"EchoReplaceLine", 1, 5, &CMacCmd::EchoEval},
  {"EchoNoLineEnd", 1, 5, &CMacCmd::EchoEval},
  {"RemoveAperture", 1, 0, &CMacCmd::RemoveAperture},
  {"ReInsertAperture", 1, 0, &CMacCmd::RemoveAperture},
  {"PhasePlateToNextPos", 0, 0, &CMacCmd::PhasePlateToNextPos},
  {"SetStageBAxis", 1, 1, &CMacCmd::SetStageBAxis},
  {"ReportStageBAxis", 0, 0, &CMacCmd::ReportStageBAxis},
  {"DeferWritingFrameMdoc", 0, 4, &CMacCmd::DeferWritingFrameMdoc},
  {"AddToNextFrameStackMdoc", 2, 4, &CMacCmd::AddToNextFrameStackMdoc},
  {"StartNextFrameStackMdoc", 2, 4, &CMacCmd::AddToNextFrameStackMdoc},
  {"ReportPhasePlatePos", 0, 0, &CMacCmd::ReportPhasePlatePos},
  {"OpenFrameMdoc", 1, 4, &CMacCmd::OpenFrameMdoc},
  {"NextProcessArgs", 1, 4, &CMacCmd::NextProcessArgs},
  {"CreateProcess", 1, 0, &CMacCmd::CreateProcess},
  {"RunExternalTool", 1, 0, &CMacCmd::RunExternalTool},
  {"ReportSpecimenShift", 0, 0, &CMacCmd::ReportSpecimenShift},
  {"ReportNavFile", 0, 0, &CMacCmd::ReportCurrentFilename},
  {"ReadNavFile", 1, 4, &CMacCmd::ReadNavFile},
  {"MergeNavFile", 1, 4, &CMacCmd::ReadNavFile},
  {"ReportIfNavOpen", 0, 4, &CMacCmd::ReportIfNavOpen}, /* End in 3.7 */
  {"NewArray", 3, 4, &CMacCmd::NewArrayCmd}, {"New2DArray", 1, 4, &CMacCmd::NewArrayCmd},
  {"AppendToArray", 2, 4, &CMacCmd::SetVariableCmd},
  {"TruncateArray", 2, 4, &CMacCmd::TruncateArray},
  {"Read2DTextFile", 2, 4, &CMacCmd::ReadTextFile},
  {"ArrayStatistics", 1, 4, &CMacCmd::ArrayStatistics},
  {"ReportFrameBaseName", 0, 0, &CMacCmd::ReportFrameBaseName},
  {"OpenTextFile", 4, 4, &CMacCmd::OpenTextFile},
  {"WriteLineToFile", 1, 4, &CMacCmd::WriteLineToFile},
  {"ReadLineToArray", 2, 4, &CMacCmd::ReadLineToArray},
  {"ReadLineToString", 2, 4, &CMacCmd::ReadLineToArray},
  {"CloseTextFile", 1, 4, &CMacCmd::CloseTextFile},
  {"FlushTextFile", 1, 4, &CMacCmd::FlushTextFile},
  {"ReadStringsFromFile", 2, 4, &CMacCmd::ReadTextFile},
  {"IsTextFileOpen", 1, 4, &CMacCmd::IsTextFileOpen},
  {"CurrentSettingsToLDArea", 1, 0, &CMacCmd::CurrentSettingsToLDArea},
  {"UpdateLowDoseParams", 1, 0, &CMacCmd::UpdateLowDoseParams},
  {"RestoreLowDoseParams", 0, 0, &CMacCmd::RestoreLowDoseParamsCmd},
  {"CallStringArray", 1, 4, &CMacCmd::DoMacro},
  {"StringArrayToScript", 1, 4, &CMacCmd::StringArrayToScript},
  {"MakeVarPersistent", 1, 4, &CMacCmd::MakeVarPersistent},
  {"SetLDAddedBeamButton", 0, 4, &CMacCmd::SetLDAddedBeamButton},
  {"KeepCameraSetChanges", 0, 4, &CMacCmd::KeepCameraSetChanges},
  {"ReportDateTime", 0, 0, &CMacCmd::ReportDateTime},
  {"ReportFilamentCurrent", 0, 0, &CMacCmd::ReportFilamentCurrent},
  {"SetFilamentCurrent", 1, 0, &CMacCmd::SetFilamentCurrent},
  {"CloseFrameMdoc", 0, 4, &CMacCmd::CloseFrameMdoc},
  {"DriftWaitTask", 0, 1, &CMacCmd::DriftWaitTask},
  {"GetWaitTaskDrift", 0, 0, &CMacCmd::GetWaitTaskDrift},
  {"CloseLogOpenNew", 0, 4, &CMacCmd::SaveLogOpenNew},
  {"SaveLog", 0, 4, &CMacCmd::SaveLog},
  {"SaveCalibrations", 0, 4, &CMacCmd::SaveCalibrations},
  {"ReportCrossoverPercentC2", 0, 0, &CMacCmd::ReportCrossoverPercentC2},
  {"ReportScreenCurrent", 0, 0, &CMacCmd::ReportScreenCurrent},
  {"ListVars", 0, 4 , &CMacCmd::ListVars},
  {"ListPersistentVars", 0, 4 , &CMacCmd::ListPersistentVars},
  {"ReportItemAcquire", 0, 0 , &CMacCmd::ReportItemAcquire},
  {"SetItemAcquire", 0, 0 , &CMacCmd::SetItemAcquire},
  {"ChangeItemNote", 1, 4 , &CMacCmd::ChangeItemRegistration},
  {"CircularSubareaMean", 3, 4 , &CMacCmd::CircularSubareaMean},
  {"ReportItemImageCoords", 0, 4, &CMacCmd::ReportItemImageCoords},
  {"SetFrameSeriesParams", 1, 4, &CMacCmd::SetFrameSeriesParams},
  {"SetCustomTime", 1, 4, &CMacCmd::SetCustomTime},
  {"ReportCustomInterval", 1, 0, &CMacCmd::SetCustomTime},
  {"StageToLastMultiHole", 0, 0, &CMacCmd::MoveStage},
  {"ImageShiftToLastMultiHole", 0, 0, &CMacCmd::ImageShiftToLastMultiHole},
  {"NavIndexItemDrawnOn", 1, 4, &CMacCmd::NavIndexItemDrawnOn},
  {"SetMapAcquireState", 1, 0, &CMacCmd::SetMapAcquireState},
  {"RestoreState", 0, 0, &CMacCmd::RestoreState},
  {"RealignToMapDrawnOn", 2, 0, &CMacCmd::RealignToMapDrawnOn},
  {"GetRealignToItemError", 0, 4, &CMacCmd::GetRealignToItemError},
  {"DoLoop", 3, 5, &CMacCmd::Loop},
  {"ReportVacuumGauge", 1, 0, &CMacCmd::ReportVacuumGauge},
  {"ReportHighVoltage", 0, 0, &CMacCmd::ReportHighVoltage},
  {"OKBox", 1, 4, &CMacCmd::OKBox},
  {"LimitNextAutoAlign", 1, 5, &CMacCmd::LimitNextAutoAlign},
  {"SetDoseRate", 1, 0, &CMacCmd::SetDoseRate},
  {"CheckForBadStripe", 0, 4, &CMacCmd::CheckForBadStripe},
  {"ReportK3CDSmode", 0, 0, &CMacCmd::ReportK3CDSmode},
  {"SetK3CDSmode", 1, 4, &CMacCmd::SetK3CDSmode},
  {"ConditionPhasePlate", 0, 0, &CMacCmd::ConditionPhasePlate},
  {"LinearFitToVars", 2, 4, &CMacCmd::LinearFitToVars},
  {"ReportNumMontagePieces", 0, 4, &CMacCmd::ReportNumMontagePieces},
  {"NavItemFileToOpen", 1, 4, &CMacCmd::NavItemFileToOpen},
  {"CropCenterToSize", 3, 0, &CMacCmd::CropImage},
  {"AcquireToMatchBuffer", 1, 0, &CMacCmd::AcquireToMatchBuffer},
  {"ReportXLensDeflector", 1, 0, &CMacCmd::ReportXLensDeflector},
  {"SetXLensDeflector", 3, 0, &CMacCmd::ReportXLensDeflector},
  {"ReportXLensFocus", 0, 0, &CMacCmd::ReportXLensDeflector},
  {"SetXLensFocus", 1, 0, &CMacCmd::ReportXLensDeflector},
  {"ExternalToolArgPlace", 1, 0, &CMacCmd::ExternalToolArgPlace},
  {"ReadOnlyUnlessAdmin", 0, 4, &CMacCmd::NoOperation},
  {"ImageShiftByStageDiff", 2, 0, &CMacCmd::ImageShiftByStageDiff},
  {"GetFileInWatchedDir", 1, 4, &CMacCmd::GetFileInWatchedDir},
  {"RunScriptInWatchedDir", 1, 4, &CMacCmd::GetFileInWatchedDir},
  {"ParseQuotedStrings", 0, 4, &CMacCmd::ParseQuotedStrings},
  {"SnapshotToFile", 6, 0, &CMacCmd::SaveToOtherFile},
  {"CombineHolesToMulti", 1, 4, &CMacCmd::CombineHolesToMulti},
  {"UndoHoleCombining", 0, 4, &CMacCmd::UndoHoleCombining},
  {"MoveStageWithSpeed", 3, 1, &CMacCmd::MoveStage},
  {"FindHoles", 0, 0, &CMacCmd::FindHoles},
  {"MakeNavPointsAtHoles", 0, 4, &CMacCmd::MakeNavPointsAtHoles},
  {"ClearHoleFinder", 0, 4, &CMacCmd::ClearHoleFinder},
  {"ReportFrameTiltSum", 0, 0, &CMacCmd::ReportFrameTiltSum},
  ...
  {"Throw", 0, 4, &CMacCmd::Throw},
  {"AlignAndTransformItems", 2, 0, &CMacCmd::AlignAndTransformItems},
  {"RotateMultiShotPattern", 1, 4, &CMacCmd::RotateMultiShotPattern},
  {"SetNavItemUserValue", 2, 6, &CMacCmd::SetNavItemUserValue},
