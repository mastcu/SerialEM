...
MDOC_FLOAT(mRefinedPixel, 0, 0., ADOC_REFINED_PIX, "RefinedPixelSpacing")
...
// DE12 items
MDOC_STRING(mDE12Version, ADOC_DE12_VERSION, "ServerSoftwareVersion")
MDOC_FLOAT(mPreExposeTime, -1., -0.1, ADOC_DE12_PREEXPOSE, "PreexposureTime(s)")
MDOC_INTEGER(mNumDE12Frames, -1, ADOC_DE12_TOTAL_FRAMES, "TotalNumberOfFrames")
MDOC_FLOAT(mDE12FPS, -1., -0.1, ADOC_DE12_FPS, "FramesPerSecond")
MDOC_STRING(mDE12Position, ADOC_CAM_POSITION, "CameraPosition")
MDOC_STRING(mDE12CoverMode, ADOC_COVER_MODE, "ProtectionCoverMode")
MDOC_INTEGER(mCoverDelay, -1, ADOC_COVER_DELAY, "ProtectionCoverOpenDelay(ms)")
MDOC_FLOAT(mTemperature, EXTRA_NO_VALUE, EXTRA_VALUE_TEST, ADOC_TEMPERATURE, "TemperatureDetector(C)")
MDOC_FLOAT(mFaraday, EXTRA_NO_VALUE, EXTRA_VALUE_TEST, ADOC_FARADAY, "FaradayPlatePeakReading(pA/cm2)")
MDOC_STRING(mSensorSerial, ADOC_SENSOR_SERIAL, "SensorModuleSerialNumber")
MDOC_INTEGER(mReadoutDelay, -1, ADOC_READOUT_DELAY, "SensorReadoutDelay(ms)")
MDOC_INTEGER(mIgnoredFrames, -1, ADOC_IGNORED_FRAMES, "IgnoredFramesInSummedImage")
