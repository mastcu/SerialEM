...
#define NAV_SKIP_COLOR   6
#define DEFAULT_POINT_COLOR 0
#define DEFAULT_POLY_COLOR 1
#define DEFAULT_MAP_COLOR 2
#define DEFAULT_SUPER_COLOR 3
#define POINT_ACQUIRE_COLOR 15
#define MAP_ACQUIRE_COLOR   16
#define HIGHLIGHT_COLOR     17
#define POLY_HIGHLIGHT_COLOR 18
...
public:
  ...
  float mFoundHoleSpacing; //Hole spacing obtained from hole finder
