...
enum UtapiSupportTypes {
  ...
  UTSUP_FILTER, UTSUP_TEMP_CONTROL, UTSUP_CAM_INSERT, UTSUP_DEFL_ALIGN,
  UTAPI_SUPPORT_END
};

enum VibrationTypes {
  VIBMGR_ACTION_AVOID, VIBMGR_ACTION_ALLOW, VIBMGR_ACTION_AUTO_ON, VIBMGR_ACTION_AUTO_OFF,
  VIBMGR_ACTION_PREPARE, VIBMGR_QUERY_STATE, VIBMGR_QUERY_AUTO, VIBMGR_QUERY_AVOIDING,
  VIBMGR_STATE_UNKNOWN, VIBMGR_STATE_NOT_VIB, VIBMGR_STATE_VIB_SOON,
  VIBMGR_STATE_VIBRATING
};
...
#define PLUGFEI_EARLY_RETURN     0x800
...
#define FRAME_FILE_MAG           (1 << 13) // 0x2000
#define FRAME_FOLDER_MAG         (1 << 14) // 0x4000
