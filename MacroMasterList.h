...
// or ints.  All numeric variables are currently listed as doubles.
...
MAC_SAME_NAME_ARG(NoMessageBoxOnError, 0, 4, NOMESSAGEBOXONERROR, d)
...
MAC_SAME_NAME_ARG(MakeVarPersistent, 1, 4, MAKEVARPERSISTENT, Sd)
...
MAC_SAME_NAME_ARG(FlashDisplay, 0, 0, FLASHDISPLAY, dds)
MAC_SAME_NAME_ARG(TiltUp, 0, 0, TILTUP, ddd)
MAC_SAME_FUNC_ARG(U, 0, 0, TiltUp, U, ddd)
MAC_SAME_NAME_ARG(TiltDown, 0, 0, TILTDOWN, ddd)
MAC_SAME_FUNC_ARG(D, 0, 0, TiltDown, D, ddd)
MAC_SAME_NAME_ARG(TiltTo, 1, 1, TILTTO, Dddd)
MAC_SAME_FUNC_ARG(TiltBy, 1, 1, TiltTo, TILTBY, Dddd)
...
MAC_SAME_FUNC_ARG(PreCookMontage, 1, 1, Montage, PRECOOKMONTAGE, Dddd)
MAC_SAME_NAME_NOARG(OppositeTrial, 0, 0, OPPOSITETRIAL)
MAC_SAME_FUNC_NOARG(OppositeFocus, 0, 0, OppositeTrial, OPPOSITEFOCUS)
MAC_SAME_FUNC_ARG(OppositeAutoFocus, 0, 0, OppositeTrial, OPPOSITEAUTOFOCUS, d)
...
MAC_SAME_NAME_ARG(EarlyReturnNextShot, 1, 5, EARLYRETURNNEXTSHOT, Dd)
MAC_SAME_NAME_NOARG(GetDeferredSum, 0, 0, GETDEFERREDSUM)
MAC_SAME_NAME_ARG(FrameThresholdNextShot, 1, 5, FRAMETHRESHOLDNEXTSHOT, Ddddd)
MAC_SAME_NAME_ARG(QueueFrameTiltSeries, 3, 4, QUEUEFRAMETILTSERIES, DDDdddddd)
MAC_SAME_FUNC_ARG(FrameSeriesFromVar, 2, 4, QueueFrameTiltSeries, FRAMESERIESFROMVAR, SDd)
MAC_SAME_NAME_ARG(SetFrameSeriesParams, 1, 4, SETFRAMESERIESPARAMS, Dddddd)
...
MAC_SAME_NAME_ARG(ModifyFrameTSShifts, 3, 5, MODIFYFRAMETSSHIFTS, DDD)
...
MAC_SAME_NAME_ARG(RecordAndTiltUp, 0, 0, RECORDANDTILTUP, ddd)
MAC_SAME_FUNC_ARG(RecordAndTiltDown, 0, 0, RecordAndTiltUp, RECORDANDTILTDOWN, ddd)
MAC_SAME_FUNC_ARG(RecordAndTiltTo, 1, 1, RecordAndTiltUp, RECORDANDTILTTO, Ddddd)
...
MAC_SAME_NAME_ARG(TestNextMultiShot, 1, 0, TESTNEXTMULTISHOT, D)
MAC_SAME_NAME_ARG(MultipleRecords, 0, 1, MULTIPLERECORDS, dddddddddddd)
MAC_SAME_NAME_ARG(RotateMultiShotPattern, 1, 4, ROTATEMULTISHOTPATTERN, Dd)
MAC_SAME_NAME_NOARG(AutoAlign, 0, 0, AUTOALIGN)
MAC_SAME_FUNC_NOARG(A, 0, 0, AutoAlign, A)
MAC_SAME_FUNC_ARG(AlignTo, 1, 0, AutoAlign, ALIGNTO, Sdd)
MAC_SAME_FUNC_ARG(ConicalAlignTo, 2, 0, AutoAlign, CONICALALIGNTO, SDd)
...
MAC_SAME_NAME_ARG(AutoFocus, 0, 0, AUTOFOCUS, dd)
MAC_SAME_FUNC_ARG(G, 0, 0, AutoFocus, G, dd)
MAC_SAME_NAME_ARG(BeamTiltDirection, 1, 5, BEAMTILTDIRECTION, D)
...
MAC_SAME_NAME_ARG(CorrectAstigmatism, 0, 0, CORRECTASTIGMATISM, d)
MAC_SAME_NAME_ARG(CorrectComa, 0, 0, CORRECTCOMA, d)
MAC_SAME_NAME_ARG(ZemlinTableau, 1, 1, ZEMLINTABLEAU, Ddd)
MAC_SAME_NAME_ARG(CBAstigComa, 3, 0, CBASTIGCOMA, DDDdd)
MAC_SAME_NAME_ARG(FixAstigmatismByCTF, 0, 0, FIXASTIGMATISMBYCTF, ddd)
MAC_SAME_FUNC_ARG(FixComaByCTF, 0, 0, FixAstigmatismByCTF, FIXCOMABYCTF, dddd)
...
MAC_SAME_NAME_ARG(Save, 0, 0, SAVE, sd)
MAC_SAME_FUNC_ARG(S, 0, 0, Save, S, sd)
MAC_SAME_NAME_ARG(ReadFile, 1, 0, READFILE, Ds)
MAC_SAME_NAME_ARG(ReadOtherFile, 3, 4, READOTHERFILE, DSS)
MAC_SAME_NAME_ARG(RetryReadOtherFile, 1, 4, RETRYREADOTHERFILE, D)
...
MAC_SAME_FUNC_ARG(OpenNewMontage, 3, 4, OpenNewFile, OPENNEWMONTAGE, DDS)
...
MAC_SAME_NAME_ARG(ChooserForNewFile, 2, 4, CHOOSERFORNEWFILE, DS)
...
MAC_SAME_NAME_ARG(OpenTextFile, 4, 4, OPENTEXTFILE, SSDS)
...
MAC_SAME_NAME_ARG(SetNewFileType, 1, 4, SETNEWFILETYPE, Dd)
...
MAC_SAME_NAME_ARG(ReportCurrentFilename, 0, 4, REPORTCURRENTFILENAME, d)
MAC_SAME_FUNC_NOARG(ReportLastFrameFile, 0, 4, ReportCurrentFilename, REPORTLASTFRAMEFILE)
MAC_SAME_FUNC_ARG(ReportNavFile, 0, 0, ReportCurrentFilename, REPORTNAVFILE, d)
...
MAC_SAME_NAME_ARG(AllowFileOverwrite, 1, 4, ALLOWFILEOVERWRITE, D)
...
MAC_SAME_NAME_ARG(SwitchToFile, 1, 4, SWITCHTOFILE, D)
...
MAC_SAME_NAME_ARG(CloseFrameMdoc, 0, 4, CLOSEFRAMEMDOC, d)
...
MAC_SAME_NAME_ARG(AlignWholeTSOnly, 0, 4, ALIGNWHOLETSONLY, d)
MAC_SAME_NAME_NOARG(WriteComForTSAlign, 0, 4, WRITECOMFORTSALIGN)
MAC_SAME_NAME_ARG(SaveLogOpenNew, 0, 4, SAVELOGOPENNEW, s)
MAC_SAME_FUNC_ARG(CloseLogOpenNew, 0, 4, SaveLogOpenNew, CLOSELOGOPENNEW, d)
MAC_SAME_NAME_ARG(SaveLog, 0, 4, SAVELOG, ds)
MAC_SAME_NAME_ARG(DeferLogUpdates, 0, 4, DEFERLOGUPDATES, d)
MAC_SAME_NAME_NOARG(SaveCalibrations, 0, 4, SAVECALIBRATIONS)
MAC_SAME_NAME_ARG(SetProperty, 2, 4, SETPROPERTY, SD)
...
MAC_SAME_NAME_ARG(SetUserSetting, 2, 4, SETUSERSETTING, SDd)
...
MAC_SAME_NAME_ARG(SetMag, 1, 0, SETMAG, Dd)
MAC_SAME_NAME_ARG(SetMagIndex, 1, 0, SETMAGINDEX, D)
MAC_SAME_NAME_ARG(ChangeMag, 1, 1, CHANGEMAG, D)
MAC_SAME_FUNC_ARG(IncMagIfFoundPixel, 1, 0, ChangeMag, INCMAGIFFOUNDPIXEL, D)
MAC_SAME_NAME_ARG(ChangeMagAndIntensity, 1, 1, CHANGEMAGANDINTENSITY, D)
MAC_SAME_FUNC_ARG(SetMagAndIntensity, 1, 0, ChangeMagAndIntensity, SETMAGANDINTENSITY, D)
MAC_SAME_NAME_ARG(SetCamLenIndex, 1, 0, SETCAMLENINDEX, D)
MAC_SAME_NAME_ARG(SetSpotSize, 1, 0, SETSPOTSIZE, D)
MAC_SAME_NAME_ARG(SetProbeMode, 1, 0, SETPROBEMODE, S)
MAC_SAME_NAME_ARG(Delay, 1, 1, DELAY, Ds)
MAC_SAME_NAME_ARG(WaitForMidnight, 0, 1, WAITFORMIDNIGHT, dddd)
MAC_SAME_NAME_ARG(WaitForDose, 1, 1, WAITFORDOSE, Dd)
...
MAC_SAME_NAME_ARG(ImageShiftByPixels, 2, 1, IMAGESHIFTBYPIXELS, DDdd)
MAC_SAME_NAME_ARG(ImageShiftByUnits, 2, 1, IMAGESHIFTBYUNITS, DDdd)
MAC_SAME_NAME_ARG(ImageShiftByMicrons, 2, 1, IMAGESHIFTBYMICRONS, DDdd)
MAC_SAME_NAME_ARG(ImageShiftByStageDiff, 2, 0, IMAGESHIFTBYSTAGEDIFF, DDdd)
MAC_SAME_NAME_NOARG(ImageShiftToLastMultiHole, 0, 0, IMAGESHIFTTOLASTMULTIHOLE)
MAC_SAME_NAME_ARG(ShiftImageForDrift, 3, 0, SHIFTIMAGEFORDRIFT, DDD)
MAC_SAME_NAME_ARG(ShiftCalSkipLensNorm, 0, 4, SHIFTCALSKIPLENSNORM, d)
MAC_SAME_NAME_ARG(CalibrateImageShift, 0, 0, CALIBRATEIMAGESHIFT, d)
...
MAC_SAME_NAME_ARG(SetImageShift, 2, 0, SETIMAGESHIFT, DDdd)
...
MAC_SAME_NAME_ARG(ReportXLensDeflector, 1, 0, REPORTXLENSDEFLECTOR, D)
MAC_SAME_FUNC_ARG(SetXLensDeflector, 3, 0, ReportXLensDeflector, SETXLENSDEFLECTOR, DDD)
...
MAC_SAME_NAME_ARG(SuppressReports, 0, 4, SUPPRESSREPORTS, d)
MAC_SAME_NAME_ARG(ErrorsToLog, 0, 4, ERRORSTOLOG, d)
...
MAC_SAME_NAME_ARG(CameraToISMatrix, 1, 4, CAMERATOISMATRIX, D)
MAC_SAME_FUNC_ARG(ISToCameraMatrix, 1, 4, CameraToISMatrix, ISTOCAMERAMATRIX, D)
MAC_SAME_FUNC_ARG(CameraToStageMatrix, 1, 4, CameraToISMatrix, CAMERATOSTAGEMATRIX, D)
MAC_SAME_FUNC_ARG(StageToCameraMatrix, 1, 4, CameraToISMatrix, STAGETOCAMERAMATRIX, D)
MAC_SAME_FUNC_ARG(CameraToSpecimenMatrix, 1, 4, CameraToISMatrix, CAMERATOSPECIMENMATRIX, D)
MAC_SAME_FUNC_ARG(SpecimenToCameraMatrix, 1, 4, CameraToISMatrix, SPECIMENTOCAMERAMATRIX, D)
MAC_SAME_FUNC_ARG(ISToSpecimenMatrix, 1, 4, CameraToISMatrix, ISTOSPECIMENMATRIX, D)
MAC_SAME_FUNC_ARG(SpecimenToISMatrix, 1, 4, CameraToISMatrix, SPECIMENTOISMATRIX, D)
MAC_SAME_FUNC_ARG(ISToStageMatrix, 1, 4, CameraToISMatrix, ISTOSTAGEMATRIX, D)
MAC_SAME_FUNC_ARG(StageToISMatrix, 1, 4, CameraToISMatrix, STAGETOISMATRIX, D)
MAC_SAME_FUNC_ARG(StageToSpecimenMatrix, 1, 4, CameraToISMatrix, STAGETOSPECIMENMATRIX, D)
MAC_SAME_FUNC_ARG(SpecimenToStageMatrix, 1, 4, CameraToISMatrix, SPECIMENTOSTAGEMATRIX, D)
...
MAC_SAME_NAME_ARG(SetFreeLensControl, 2, 1, SETFREELENSCONTROL, DD)
MAC_SAME_NAME_ARG(SetLensWithFLC, 2, 0, SETLENSWITHFLC, DDd)
MAC_SAME_NAME_ARG(ReportLensFLCStatus, 1, 0, REPORTLENSFLCSTATUS, D)
MAC_SAME_NAME_ARG(SetJeolSTEMflags, 2, 2, SETJEOLSTEMFLAGS, DD)
MAC_SAME_NAME_NOARG(SetCameraPLAOffset, 0, 0, SETCAMERAPLAOFFSET)
MAC_SAME_NAME_ARG(RemoveAperture, 1, 0, REMOVEAPERTURE, D)
MAC_SAME_FUNC_ARG(ReInsertAperture, 1, 0, RemoveAperture, REINSERTAPERTURE, D)
...
MAC_SAME_NAME_ARG(ReportMeanCounts, 0, 0, REPORTMEANCOUNTS, sd)
MAC_SAME_NAME_NOARG(ReportFileZsize, 0, 0, REPORTFILEZSIZE)
MAC_SAME_NAME_ARG(SubareaMean, 4, 5, SUBAREAMEAN, DDDD)
...
MAC_SAME_NAME_ARG(CropImage, 5, 1, CROPIMAGE, SDDDD)
MAC_SAME_FUNC_ARG(CropCenterToSize, 3, 0, CropImage, CROPCENTERTOSIZE, SDD)
MAC_SAME_NAME_ARG(ReduceImage, 2, 1, REDUCEIMAGE, SD)
MAC_SAME_NAME_ARG(FFT, 1, 0, FFT, Sd)
...
MAC_SAME_NAME_ARG(ScaleImage, 3, 1, SCALEIMAGE, SDDsd)
MAC_SAME_NAME_ARG(CtfFind, 3, 1, CTFFIND, SDDddddd)
...
MAC_SAME_NAME_ARG(QuadrantMeans, 0, 4, QUADRANTMEANS, ddd)
MAC_SAME_NAME_ARG(CheckForBadStripe, 0, 4, CHECKFORBADSTRIPE, sd)
...
MAC_SAME_NAME_ARG(ProgramTimeStamps, 0, 4, PROGRAMTIMESTAMPS, d)
...
MAC_SAME_FUNC_ARG(EnterDefaultedNumber, 3, 4, EnterOneNumber, ENTERDEFAULTEDNUMBER, DDS)
...
MAC_SAME_NAME_ARG(ClearAlignment, 0, 0, CLEARALIGNMENT, d)
MAC_SAME_NAME_ARG(ResetImageShift, 0, 0, RESETIMAGESHIFT, dd)
MAC_SAME_NAME_ARG(ResetShiftIfAbove, 1, 1, RESETSHIFTIFABOVE, D)
MAC_SAME_NAME_ARG(Eucentricity, 0, 0, EUCENTRICITY, d)
...
MAC_SAME_NAME_ARG(ReverseTilt, 0, 0, REVERSETILT, d)
MAC_SAME_NAME_ARG(DriftWaitTask, 0, 1, DRIFTWAITTASK, dsdddsddd)
MAC_SAME_NAME_ARG(ConditionPhasePlate, 0, 0, CONDITIONPHASEPLATE, d)
MAC_SAME_NAME_NOARG(GetWaitTaskDrift, 0, 0, GETWAITTASKDRIFT)
MAC_SAME_NAME_NOARG(BacklashAdjust, 0, 0, BACKLASHADJUST)
MAC_SAME_NAME_ARG(CenterBeamFromImage, 0, 0, CENTERBEAMFROMIMAGE, dd)
...
MAC_SAME_NAME_ARG(SetAlpha, 1, 0, SETALPHA, D)
MAC_SAME_NAME_NOARG(ReportJeolGIF, 0, 0, REPORTJEOLGIF)
MAC_SAME_NAME_ARG(SetJeolGIF, 1, 0, SETJEOLGIF, D)
MAC_SAME_NAME_ARG(NormalizeLenses, 1, 0, NORMALIZELENSES, D)
MAC_SAME_NAME_ARG(NormalizeAllLenses, 0, 0, NORMALIZEALLLENSES, d)
MAC_SAME_NAME_ARG(ReportSlotStatus, 1, 4, REPORTSLOTSTATUS, D)
MAC_SAME_NAME_ARG(LoadCartridge, 1, 0, LOADCARTRIDGE, D)
MAC_SAME_FUNC_NOARG(UnloadCartridge, 0, 0, LoadCartridge, UNLOADCARTRIDGE)
MAC_SAME_NAME_ARG(RefrigerantLevel, 1, 4, REFRIGERANTLEVEL, D)
...
MAC_SAME_NAME_ARG(SetSlitIn, 0, 1, SETSLITIN, d)
MAC_SAME_NAME_ARG(RefineZLP, 0, 0, REFINEZLP, d)
MAC_SAME_NAME_ARG(SelectCamera, 1, 0, SELECTCAMERA, D)
MAC_SAME_NAME_ARG(SetExposure, 2, 0, SETEXPOSURE, SDd)
MAC_SAME_NAME_ARG(SetBinning, 2, 4, SETBINNING, SD)
MAC_SAME_NAME_ARG(SetCameraArea, 2, 4, SETCAMERAAREA, SSddd)
MAC_SAME_NAME_ARG(SetCenteredSize, 4, 4, SETCENTEREDSIZE, SDDD)
MAC_SAME_NAME_ARG(SetExposureForMean, 1, 0, SETEXPOSUREFORMEAN, Dd)
MAC_SAME_NAME_ARG(SetContinuous, 2, 2, SETCONTINUOUS, SD)
MAC_SAME_NAME_ARG(SetProcessing, 2, 4, SETPROCESSING, SD)
...
MAC_SAME_NAME_ARG(SetK2ReadMode, 2, 4, SETK2READMODE, SD)
MAC_SAME_NAME_ARG(SetDoseFracParams, 2, 4, SETDOSEFRACPARAMS, SDdddd)
MAC_SAME_NAME_ARG(SetDECamFrameRate, 1, 4, SETDECAMFRAMERATE, D)
MAC_SAME_NAME_ARG(UseContinuousFrames, 1, 4, USECONTINUOUSFRAMES, D)
MAC_SAME_NAME_NOARG(StopContinuous, 0, 0, STOPCONTINUOUS)
MAC_SAME_NAME_NOARG(ReportContinuous, 0, 4, REPORTCONTINUOUS)
MAC_SAME_NAME_ARG(StartFrameWaitTimer, 0, 4, STARTFRAMEWAITTIMER, d)
MAC_SAME_NAME_ARG(WaitForNextFrame, 0, 0, WAITFORNEXTFRAME, dd)
MAC_SAME_NAME_ARG(SetLiveSettleFraction, 1, 4, SETLIVESETTLEFRACTION, D)
MAC_SAME_NAME_ARG(SetSTEMDetectors, 2, 0, SETSTEMDETECTORS, SDddddddd)
...
MAC_SAME_NAME_ARG(SetK2FileParams, 1, 4, SETK2FILEPARAMS, Dddddd)
MAC_SAME_NAME_NOARG(ReportFrameAliParams, 0, 0, REPORTFRAMEALIPARAMS)
MAC_SAME_FUNC_ARG(SetFrameAliParams, 1, 4, ReportFrameAliParams, SETFRAMEALIPARAMS, Dddddd)
MAC_SAME_FUNC_ARG(SetFrameAli2, 1, 4, ReportFrameAliParams, SETFRAMEALI2, Dddddd)
...
MAC_SAME_NAME_ARG(SkipFrameAliParamCheck, 0, 4, SKIPFRAMEALIPARAMCHECK, d)
MAC_SAME_NAME_NOARG(ReportK3CDSmode, 0, 0, REPORTK3CDSMODE)
MAC_SAME_NAME_ARG(SetK3CDSmode, 1, 4, SETK3CDSMODE, Dd)
MAC_SAME_NAME_NOARG(ReportCountScaling, 0, 0, REPORTCOUNTSCALING)
MAC_SAME_NAME_ARG(SetDivideBy2, 1, 4, SETDIVIDEBY2, D)
MAC_SAME_NAME_NOARG(ReportNumFramesSaved, 0, 0, REPORTNUMFRAMESSAVED)
MAC_SAME_NAME_ARG(CameraProperties, 0, 4, CAMERAPROPERTIES, dd)
MAC_SAME_NAME_NOARG(ReportColumnOrGunValve, 0, 0, REPORTCOLUMNORGUNVALVE)
MAC_SAME_NAME_ARG(SetColumnOrGunValve, 1, 0, SETCOLUMNORGUNVALVE, D)
...
MAC_SAME_NAME_ARG(SetBeamBlank, 1, 0, SETBEAMBLANK, D)
MAC_SAME_NAME_ARG(MoveToNavItem, 0, 0, MOVETONAVITEM, d)
MAC_SAME_NAME_ARG(RealignToNavItem, 1, 0, REALIGNTONAVITEM, Ddddd)
MAC_SAME_FUNC_ARG(RealignToOtherItem, 2, 0, RealignToNavItem, REALIGNTOOTHERITEM, DDdddd)
MAC_SAME_NAME_ARG(RealignToMapDrawnOn, 2, 0, REALIGNTOMAPDRAWNON, DD)
MAC_SAME_NAME_NOARG(GetRealignToItemError, 0, 4, GETREALIGNTOITEMERROR)
MAC_SAME_NAME_NOARG(ReportNavItem, 0, 0, REPORTNAVITEM)
MAC_SAME_FUNC_ARG(ReportOtherItem, 1, 0, ReportNavItem, REPORTOTHERITEM, D)
MAC_SAME_FUNC_ARG(LoadNavMap, 0, 0, ReportNavItem, LOADNAVMAP, s)
MAC_SAME_FUNC_ARG(LoadOtherMap, 1, 0, ReportNavItem, LOADOTHERMAP, Ds)
MAC_SAME_FUNC_NOARG(ReportNextNavAcqItem, 0, 4, ReportNavItem, REPORTNEXTNAVACQITEM)
MAC_SAME_NAME_ARG(ReportItemAcquire, 0, 0 , REPORTITEMACQUIRE, d)
MAC_SAME_NAME_ARG(SetItemAcquire, 0, 0 , SETITEMACQUIRE, dd)
...
MAC_SAME_NAME_ARG(NavIndexItemDrawnOn, 1, 4, NAVINDEXITEMDRAWNON, D)
MAC_SAME_NAME_ARG(NavItemFileToOpen, 1, 4, NAVITEMFILETOOPEN, D)
MAC_SAME_NAME_ARG(SetNavItemUserValue, 2, 6, SETNAVITEMUSERVALUE, DDs)
MAC_SAME_FUNC_ARG(ReportItemUserValue, 2, 0, SetNavItemUserValue, REPORTITEMUSERVALUE, DD)
MAC_SAME_NAME_ARG(SetMapAcquireState, 1, 0, SETMAPACQUIRESTATE, D)
MAC_SAME_NAME_NOARG(RestoreState, 0, 0, RESTORESTATE)
MAC_SAME_NAME_NOARG(ReportNumNavAcquire, 0, 0, REPORTNUMNAVACQUIRE)
MAC_SAME_NAME_ARG(ReportNumHoleAcquire, 0, 0, REPORTNUMHOLEACQUIRE, ddd)
MAC_SAME_NAME_NOARG(ReportNumTableItems, 0, 4, REPORTNUMTABLEITEMS)
MAC_SAME_NAME_ARG(SetNavRegistration, 1, 4, SETNAVREGISTRATION, D)
...
MAC_SAME_NAME_ARG(ChangeItemRegistration, 2, 5, CHANGEITEMREGISTRATION, DD)
MAC_SAME_FUNC_ARG(ChangeItemColor, 2, 4, ChangeItemRegistration, CHANGEITEMCOLOR, DD)
MAC_SAME_FUNC_ARG(ChangeItemLabel, 2, 4, ChangeItemRegistration, CHANGEITEMLABEL, DS)
MAC_SAME_FUNC_ARG(ChangeItemNote, 1, 4 , ChangeItemRegistration, CHANGEITEMNOTE, Ds)
MAC_SAME_NAME_ARG(SetItemTargetDefocus, 2, 4, SETITEMTARGETDEFOCUS, DD)
MAC_SAME_NAME_ARG(SetItemSeriesAngles, 3, 4, SETITEMSERIESANGLES, DDDd)
MAC_SAME_NAME_NOARG(SkipAcquiringNavItem, 0, 4, SKIPACQUIRINGNAVITEM)
MAC_SAME_NAME_ARG(SkipAcquiringGroup, 0, 4, SKIPACQUIRINGGROUP, d)
MAC_SAME_NAME_ARG(SkipMoveInNavAcquire, 0, 4, SKIPMOVEINNAVACQUIRE, d)
MAC_SAME_NAME_ARG(SuspendNavRedraw, 0, 4, SUSPENDNAVREDRAW, d)
...
MAC_SAME_NAME_ARG(ItemForSuperCoord, 1, 4, ITEMFORSUPERCOORD, D)
...
MAC_SAME_NAME_ARG(ReportItemImageCoords, 0, 4, REPORTITEMIMAGECOORDS, ds)
MAC_SAME_NAME_ARG(NewMap, 0, 0, NEWMAP, ds)
...
MAC_SAME_NAME_ARG(ShiftItemsByMicrons, 2, 5, SHIFTITEMSBYMICRONS, DDd)
...
MAC_SAME_NAME_ARG(SkipPiecesOutsideItem, 1, 4, SKIPPIECESOUTSIDEITEM, D)
MAC_SAME_NAME_ARG(FindHoles, 0, 0, FINDHOLES, s)
MAC_SAME_NAME_ARG(MakeNavPointsAtHoles, 0, 4, MAKENAVPOINTSATHOLES, ddddd)
MAC_SAME_NAME_NOARG(ClearHoleFinder, 0, 4, CLEARHOLEFINDER)
MAC_SAME_NAME_ARG(CombineHolesToMulti, 1, 4, COMBINEHOLESTOMULTI, D)
MAC_SAME_NAME_NOARG(UndoHoleCombining, 0, 4, UNDOHOLECOMBINING)
MAC_SAME_NAME_ARG(SetHelperParams, 1, 4, SETHELPERPARAMS, Dddd)
MAC_SAME_NAME_ARG(SetMontageParams, 1, 4, SETMONTAGEPARAMS, Dddddd)
MAC_SAME_NAME_ARG(ManualFilmExposure, 1, 1, MANUALFILMEXPOSURE, D)
MAC_SAME_NAME_NOARG(ExposeFilm, 0, 1, EXPOSEFILM)
MAC_SAME_FUNC_ARG(SpecialExposeFilm, 1, 1, ExposeFilm, SPECIALEXPOSEFILM, Ddd)
MAC_SAME_NAME_ARG(GoToLowDoseArea, 1, 0, GOTOLOWDOSEAREA, S)
MAC_SAME_NAME_ARG(SetLDContinuousUpdate, 1, 4, SETLDCONTINUOUSUPDATE, D)
MAC_SAME_NAME_ARG(SetLowDoseMode, 1, 0, SETLOWDOSEMODE, D)
...
MAC_SAME_NAME_ARG(UpdateLowDoseParams, 1, 0, UPDATELOWDOSEPARAMS, Sd)
MAC_DIFF_NAME_ARG(RestoreLowDoseParams, 0, 0, RestoreLowDoseParamsCmd, RESTORELOWDOSEPARAMS, s)
MAC_SAME_NAME_ARG(SetLDAddedBeamButton, 0, 4, SETLDADDEDBEAMBUTTON, d)
MAC_SAME_NAME_ARG(ShowMessageOnScope, 1, 0, SHOWMESSAGEONSCOPE, S)
MAC_SAME_NAME_ARG(SetupScopeMessage, 1, 6, SETUPSCOPEMESSAGE, Dds)
...
MAC_SAME_NAME_ARG(NewDEserverDarkRef, 2, 0, NEWDESERVERDARKREF, DD)
...
MAC_SAME_NAME_ARG(ExternalToolArgPlace, 1, 0, EXTERNALTOOLARGPLACE, D)
...
MAC_SAME_NAME_ARG(SelectPiezo, 2, 0, SELECTPIEZO, DD)
MAC_SAME_NAME_NOARG(ReportPiezoXY, 0, 0, REPORTPIEZOXY)
MAC_SAME_NAME_NOARG(ReportPiezoZ, 0, 0, REPORTPIEZOZ)
MAC_SAME_NAME_ARG(MovePiezoXY, 2, 1, MOVEPIEZOXY, DDd)
MAC_SAME_NAME_ARG(MovePiezoZ, 1, 1, MOVEPIEZOZ, Dd)
