...
MAC_DIFF_NAME_ARG(SetVariable, 0, 4, SetVariableCmd, SETVARIABLE, SS)
MAC_SAME_FUNC_ARG(SetPersistentVar, 0, 4, SetVariableCmd, SETPERSISTENTVAR, SS)
MAC_SAME_NAME_ARG(GetVariable, 1, 4, GETVARIABLE, S)
MAC_SAME_NAME(SetStringVar, 0, 4, SETSTRINGVAR)
...
MAC_SAME_NAME_NOARG(EndTry, 0, 4, ENDTRY)
...
MAC_SAME_FUNC_ARG(FrameSeriesFromVar, 2, 4, QueueFrameTiltSeries, FRAMESERIESFROMVAR, SIdd)
...
MAC_SAME_FUNC_ARG(AlignTo, 1, 0, AutoAlign, ALIGNTO, Siiiidddi)
...
MAC_SAME_NAME_ARG(SetEucentricFocus, 0, 4, SETEUCENTRICFOCUS, d)
...
MAC_SAME_NAME_ARG(WaitForMidnight, 0, 1, WAITFORMIDNIGHT, ddiii)
...
MAC_SAME_NAME_ARG(ProgramTimeStamps, 0, 4, PROGRAMTIMESTAMPS, ii)
...
MAC_SAME_NAME_ARG(Eucentricity, 0, 0, EUCENTRICITY, ii)
...
MAC_SAME_NAME_ARG(SetDoseRate, 1, 0, SETDOSERATE, Di)
...
MAC_SAME_NAME_ARG(RefineZLP, 0, 0, REFINEZLP, diii)
...
MAC_SAME_NAME_ARG(SetCenteredSize, 4, 4, SETCENTEREDSIZE, SDII)
...
MAC_SAME_NAME_ARG(RestoreState, 0, 0, RESTORESTATE, i)
...
MAC_SAME_NAME_ARG(ShiftItemsByMicrons, 2, 5, SHIFTITEMSBYMICRONS, DDii)
...
MAC_SAME_NAME_ARG(FindHoles, 0, 0, FINDHOLES, sss)
MAC_SAME_NAME_ARG(MakeNavPointsAtHoles, 0, 4, MAKENAVPOINTSATHOLES, idddddi)
...
MAC_SAME_NAME_ARG(SetMontageParams, 1, 4, SETMONTAGEPARAMS, Iiiiiidd)
...
MAC_SAME_NAME_ARG(SetAxisPosition, 2, 0, SETAXISPOSITION, SDdi)
...
MAC_SAME_NAME_ARG(RunGatanScript, 1, 0, RunGatanScript, Sd)
...
MAC_SAME_FUNC_ARG(RunProcess, 1, 0, CreateProcess, RUNPROCESS, S)
...
MAC_SAME_NAME_ARG(AutoContourGridSquares, 3, 0, AUTOCONTOURGRIDSQUARES, Sdddddid)
...
MAC_SAME_NAME_ARG(SetHoleFinderParams, 3, 4, SETHOLEFINDERPARAMS, DDIdssi)
...
MAC_SAME_NAME_ARG(ParamSetToUseForMontage, 1, 4, PARAMSETTOUSEFORMONTAGE, Ii)
...
MAC_SAME_NAME_ARG(EndAcquireAtItems, 0, 4, ENDACQUIREATITEMS, i)
...
MAC_SAME_FUNC_ARG(SetTiltSeriesAtItem, 0, 0, SetItemAcquire, SETTILTSERIESATITEM, ii)
...
MAC_SAME_NAME_ARG(SetMultishotParams, 1, 4, SETMULTISHOTPARAMS, Iiddiiiiiiidiid)
...
MAC_SAME_FUNC_ARG(PluginAllDoubles, 2, 1, Plugin, PLUGINALLDOUBLES, SSddddddd)
MAC_SAME_FUNC_ARG(PluginString, 3, 1, Plugin, PLUGINSTRING, SSS)
...
MAC_SAME_NAME_ARG(FindMultiMapHoles, 3, 1, FINDMULTIMAPHOLES, IIIidddddd)
MAC_SAME_NAME_NOARG(NavGoToMarker, 0, 0, NAVGOTOMARKER)
MAC_SAME_NAME_ARG(ReportLDDefocusOffset, 1, 4, REPORTLDDEFOCUSOFFSET, S)
MAC_SAME_NAME_ARG(SetLDDefocusOffset, 2, 4, SetLDDEFOCUSOFFSET, SD)
...
MAC_SAME_NAME_ARG(FindAndCenterOneHole, 2, 4, FINDANDCENTERONEHOLE, SDidddddi)
