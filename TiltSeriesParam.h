...
#define TSFLAG_PAR_USE_MAXTILT    0x2
...
struct TiltSeriesParam {
  ...
  BOOL dosymTrackBigReversal;  // Flag to track reversals above an amount
  int dosymBigTiltToTrack;     // Amount tilted that triggers tracking
